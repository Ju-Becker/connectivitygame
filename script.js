...
function updateStatus(text) {
  ...
  pointselement.textContent = roundsplayed-4*blitzused-8*rednodemoveuse-12*addreduse;
}
...
function itemsavailable(){
  let points = parseInt(move_history.length/2)-4*blitzused-8*rednodemoveuse-12*addreduse;
